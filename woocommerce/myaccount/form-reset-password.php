...
<form method="post" class="reset-pw-form woocommerce-ResetPassword lost_reset_password">

	<p class="reset-password-description">Enter a new password below</p><?php // @codingStandardsIgnoreLine ?>
