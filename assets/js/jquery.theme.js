(function ($) {
  ...
  let hamburgerMenuButton = $('#hamburger-menu-button');
  ...
  var $magnifyIcon = $('<img class="magnify-icon" src="https://hheerraa.co.kr/wp-content/themes/hera/assets/img/magnify_main.png" alt="magnify img">');
    ...
    $('.rbs-img-thumbnail-container img').on('click', function (e) {
      setTimeout(function (e) {
        ...
        $('.mfp-arrow.mfp-arrow-right.mfp-prevent-close').css({
          "background-image": 'url(https://hheerraa.co.kr/wp-content/themes/hera/assets/img/left-white.png) !important'
        });
